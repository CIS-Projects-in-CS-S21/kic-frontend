...
goog.exportSymbol('proto.kic.health.HealthDataError', null, global);
goog.exportSymbol('proto.kic.health.HealthDataErrorResponse', null, global);
 ...
 * @constructor
 */
proto.kic.health.HealthDataErrorResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.kic.health.HealthDataErrorResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.kic.health.HealthDataErrorResponse.displayName = 'proto.kic.health.HealthDataErrorResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.kic.health.HealthDataErrorResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.kic.health.HealthDataErrorResponse.toObject(opt_includeInstance, this);
};
 ...
 *     http://goto/soy-param-migration
 * @param {!proto.kic.health.HealthDataErrorResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.kic.health.HealthDataErrorResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.kic.health.HealthDataErrorResponse}
 */
proto.kic.health.HealthDataErrorResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.kic.health.HealthDataErrorResponse;
  return proto.kic.health.HealthDataErrorResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @param {!proto.kic.health.HealthDataErrorResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.kic.health.HealthDataErrorResponse}
 */
proto.kic.health.HealthDataErrorResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = /** @type {!proto.kic.health.HealthDataError} */ (reader.readEnum());
      msg.setError(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.kic.health.HealthDataErrorResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.kic.health.HealthDataErrorResponse.serializeBinaryToWriter(this, writer);
 ...
 * @param {!proto.kic.health.HealthDataErrorResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.kic.health.HealthDataErrorResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getError();
  if (f !== 0.0) {
    writer.writeEnum(
...
/**
 * optional HealthDataError error = 1;
 * @return {!proto.kic.health.HealthDataError}
 */
proto.kic.health.HealthDataErrorResponse.prototype.getError = function() {
  return /** @type {!proto.kic.health.HealthDataError} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/**
 * @param {!proto.kic.health.HealthDataError} value
 * @return {!proto.kic.health.HealthDataErrorResponse} returns this
 */
proto.kic.health.HealthDataErrorResponse.prototype.setError = function(value) {
 ...
 * @const
 */
proto.kic.health.GetHealthDataForUserResponse.repeatedFields_ = [2];
 ...
 * @return {!proto.kic.health.HealthDataError}
 */
proto.kic.health.GetHealthDataForUserResponse.prototype.getError = function() {
  return /** @type {!proto.kic.health.HealthDataError} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
 ...
 */
proto.kic.health.GetHealthDataForUserResponse.prototype.setError = function(value) {
  return jspb.Message.setProto3EnumField(this, 1, value);
};
...
proto.kic.health.GetHealthDataForUserResponse.prototype.getHealthdataList = function() {
  return /** @type{!Array<!proto.kic.health.MentalHealthLog>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.kic.health.MentalHealthLog, 2));
};
...
proto.kic.health.GetHealthDataForUserResponse.prototype.addHealthdata = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.kic.health.MentalHealthLog, opt_index);
};
...
proto.kic.health.DeleteHealthDataForUserResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    error: jspb.Message.getFieldWithDefault(msg, 1, 0),
    entriesdeleted: jspb.Message.getFieldWithDefault(msg, 2, 0)
  };
 ...
 * @return {!proto.kic.health.HealthDataError}
 */
proto.kic.health.DeleteHealthDataForUserResponse.prototype.getError = function() {
  return /** @type {!proto.kic.health.HealthDataError} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
 ...
 */
proto.kic.health.DeleteHealthDataForUserResponse.prototype.setError = function(value) {
  return jspb.Message.setProto3EnumField(this, 1, value);
};


/**
 * optional uint32 entriesDeleted = 2;
 * @return {number}
 */
 ...
 * @enum {number}
 */
proto.kic.health.HealthDataError = {
  USER_NOT_FOUND: 0,
  DATE_NOT_FOUND: 1
};
